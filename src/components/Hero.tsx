...
export default function Hero() {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-[#1A1A1A]">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-xl md:text-2xl text-gray-400 leading-relaxed mb-12 max-w-2xl font-medium"
          >
          ...
          >
            ...
            <div className="hidden md:flex items-center gap-4">
              <Zap className="text-[#ED1C24] w-8 h-8" />
              <div>
                <div className="text-white font-black text-2xl tracking-tighter">TODO MÉXICO</div>
                <div className="text-gray-400 text-xs font-bold uppercase tracking-widest">Alcance Nacional</div>
              </div>
            </div>
          </motion.div>
        </div>
